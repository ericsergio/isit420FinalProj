    ...
    public partial class SportsCardsContext : DbContext
	{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server = tcp:es2022.database.windows.net, 1433; Initial Catalog = SportsCards; Persist Security Info = False; User ID = isit420ericsergiodb; Password=<password>; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;", builder => builder.EnableRetryOnFailure());
