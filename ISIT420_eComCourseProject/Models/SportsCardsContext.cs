...
<<<<<<< HEAD
                optionsBuilder.UseSqlServer("Server = tcp:es2022.database.windows.net, 1433; Initial Catalog = SportsCards; Persist Security Info = False; User ID = isit420ericsergiodb; Password=ch3ck3rBo@rd; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;", builder => builder.EnableRetryOnFailure());
                //optionsBuilder.UseSqlServer(Conn, builder => builder.EnableRetryOnFailure());
=======
...
>>>>>>> 7bac57d00a1dfe0a57f252cdaa19f5ff4e3ee901
            }
        }
